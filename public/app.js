...
const cracowId = "3094802";

window.addEventListener('load', e => {
  new getTodaysWeather(cracowId);
  registerSW();
});
...
function getTodaysWeather(cityId) {
  let api = `https://api.openweathermap.org/data/2.5/weather?id=${cityId}&appid=${key}&lang=en`;
